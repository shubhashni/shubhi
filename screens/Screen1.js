...
import { dh, dh_w, dw, dw_w } from "./Dimension";
...
export default function Screen1({navigation}) {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.BS_txt}>Best Silling</Text>
...
const styles = StyleSheet.create({
  ...
  lineShort: {
    width: 15,
    height: 3,
    backgroundColor: "#1c1c2b", // dark navy/black color
    borderRadius: 2,
    marginVertical: 2,
  },
  lineShort2: {
  ...
  bottom_cart: {
    ...
    alignItems: "center",
    marginHorizontal: 20,
    justifyContent: "space-between", // space between all three
    padding: 10,
    backgroundColor: "#fff",
    borderRadius: 10,
  ...
  BC_img: {
    ...
    marginRight: 20,
    borderRadius: 10,
    overflow: "hidden", // for rounded image
  },
